...
<p align="center"><em>Software Engineer · Systems Thinker · Building at the intersection of AI, product, and markets</em></p>
...
| Frontend | React.js, Next.js, React Native, Remix.js, Vue.js, TailwindCSS |
| Backend | Node.js, FastAPI, REST APIs, WebSockets |
| Data & AI | PyTorch, Scikit-Learn, XGBoost, Pandas, NumPy, Gemini API |
| Infrastructure | AWS, Supabase, PostgreSQL, Redis, Docker, GitHub Actions |
